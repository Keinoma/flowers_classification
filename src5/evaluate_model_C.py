...
# Project imports
from load_data_C import load_flower_data
from model_C import create_model, FlowerResNet 
...
CHECKPOINT_PATH = SRC_DIR / 'checkpoints' / f'run_seed{eval_args.seed}' / 'best_model_C.pth'
...
class ModelEvaluator:
    ...
    def evaluate_confusion_matrix(self):
        ...
        plt.tight_layout()
        raw_path = RESULTS_DIR / 'confusion_matrix_C.png'
        ...
        plt.tight_layout()
        norm_path = RESULTS_DIR / 'confusion_matrix_normalized_C.png'
    ...
    def evaluate_roc_auc(self):
        ...
        plt.tight_layout()
        roc_path = RESULTS_DIR / 'roc_curves_C.png'
    ...
    def evaluate_calibration(self, n_bins: int = 10):
        ...
        plt.tight_layout()
        calib_path = RESULTS_DIR / 'reliability_diagram_C.png'
    ...
    def evaluate_temporal_performance(self):
        ...
        plt.tight_layout()
        throughput_path = RESULTS_DIR / 'inference_throughput_C.png'
    ...
    def evaluate_confidence_distribution(self):
        ...
        plt.tight_layout()
        conf_path = RESULTS_DIR / 'confidence_distribution_C.png'
    ...
    def generate_reports(self):
        ...
        # --- JSON Report ---
        json_path = RESULTS_DIR / 'evaluation_report_C.json'
        ...
        summary_text = "\n".join(summary_lines)
        txt_path = RESULTS_DIR / 'evaluation_summary_C.txt'
