...
checkpoint = torch.load("checkpoints/best_model_C.pth", weights_only=True)
...
def main():
    ...
    if len(sys.argv) < 2:
        print("Usage: python predict_C.py <chemin_vers_image>")
        print("Exemple: python predict_C.py data/5_classes/Lilly/00a7.jpg")
        sys.exit(1)
