...
Run from src1/ with: python evaluate_model.py
"""
...
from model import create_model, FlowerCNN
from train import prepare_dataloaders, get_transforms, FlowerDataset

warnings.filterwarnings('ignore')
import argparse
eval_parser = argparse.ArgumentParser(description='Évaluation Baseline')
...
CHECKPOINT_PATH = SRC_DIR / 'checkpoints' / f'run_seed{eval_args.seed}' / 'best_model.pth'
...
class ModelEvaluator:
    ...
    def evaluate_confusion_matrix(self):
        ...
        plt.tight_layout()
        raw_path = RESULTS_DIR / 'confusion_matrix.png'
        ...
        plt.tight_layout()
        norm_path = RESULTS_DIR / 'confusion_matrix_normalized.png'
    ...
    def evaluate_calibration(self, n_bins: int = 10):
        ...
        plt.tight_layout()
        calib_path = RESULTS_DIR / 'reliability_diagram.png'
    ...
    """def evaluate_kfold_cross_validation(self):
        ...
        plt.tight_layout()
        kfold_path = RESULTS_DIR / 'kfold_boxplot.png'
    ...
    def evaluate_temporal_performance(self):
        ...
        plt.tight_layout()
        throughput_path = RESULTS_DIR / 'inference_throughput.png'
    ...
    def generate_reports(self):
        ...
        summary_lines.append(f"Model: FlowerCNN (Baseline — From Scratch)")
        ...
        summary_text = "\n".join(summary_lines)
        txt_path = RESULTS_DIR / 'evaluation_summary.txt'
