...
Run from src3/ with: python evaluate_model_B.py
"""
...
# Project imports
from load_data_B_p import load_flower_data
from model_B_p import create_model, FlowerResNet 
from train_B_p import prepare_dataloaders, get_transforms, FlowerDataset
...
CHECKPOINT_PATH = SRC_DIR / 'checkpoints' / f'run_seed{eval_args.seed}' / 'best_model_B_p.pth'
...
class ModelEvaluator:
    ...
    def evaluate_confusion_matrix(self):
        ...
        ax.set_title('Confusion Matrix_B', fontsize=14, fontweight='bold')
        ...
        plt.tight_layout()
        raw_path = RESULTS_DIR / 'confusion_matrix_B.png'
        ...
        plt.tight_layout()
        norm_path = RESULTS_DIR / 'confusion_matrix_normalized_B.png'
    ...
    def evaluate_roc_auc(self):
        ...
        plt.tight_layout()
        roc_path = RESULTS_DIR / 'roc_curves_B.png'
    ...
    def evaluate_calibration(self, n_bins: int = 10):
        ...
        plt.tight_layout()
        calib_path = RESULTS_DIR / 'reliability_diagram_B.png'
    ...
    """def evaluate_kfold_cross_validation(self):
        ...
        plt.tight_layout()
        kfold_path = RESULTS_DIR / 'kfold_boxplot_B.png'
    ...
    def evaluate_temporal_performance(self):
        ...
        plt.tight_layout()
        throughput_path = RESULTS_DIR / 'inference_throughput_B.png'
    ...
    def evaluate_confidence_distribution(self):
        ...
        plt.tight_layout()
        conf_path = RESULTS_DIR / 'confidence_distribution_B.png'
    ...
    def generate_reports(self):
        ...
        # --- JSON Report ---
        json_path = RESULTS_DIR / 'evaluation_report_B.json'
        ...
        summary_lines.append(f"Model: FlowerResNet (Groupe B — Data Augmentation)")
        ...
        summary_text = "\n".join(summary_lines)
        txt_path = RESULTS_DIR / 'evaluation_summary_B.txt'
