...
# Charger le modèle
model = create_model(num_classes=5, freeze_backbone=False, device=DEVICE)
...
# Pr exécuter :
# se déplacer dans C:\Flowers Classification\code> (c'est tt)
# python src1\predict.py data\5_classes\Lilly\Li333.jpg