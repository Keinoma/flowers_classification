...
checkpoint = torch.load("checkpoints/best_model_B.pth", weights_only=True)
...
def main():
    ...
    if len(sys.argv) < 2:
        print("Usage: python predict_B.py <chemin_vers_image>")
        print("Exemple: python predict_B.py data/5_classes/Lilly/00a7.jpg")
        sys.exit(1)
