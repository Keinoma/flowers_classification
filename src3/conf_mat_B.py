"""
reproduce_confusion_matrix_B.py
...
CHECKPOINT_PATH = SRC_DIR / 'checkpoints' / 'best_model_B.pth'
...
def main():
    print("=" * 70)
    print("  🌸 RECONSTRUCTION DE LA MATRICE DE CONFUSION (GROUPE B) 🌸")
    print("=" * 70)
    ...
    plt.title('Matrice de Confusion (Groupe B)', fontsize=14, fontweight='bold')
    plt.colorbar()
    ...
    # Sauvegarde
    save_path = SRC_DIR / 'checkpoints' / 'conf_mat_B.png'
